                ...
                <div className="padding-global padding-section-medium">
                    <div className="container-large">
                        <div className="w-layout-grid grid-3gap">
                            <div data-w-id="db77a3fc-85cd-1cf5-6ef4-8b2e1d14e6cc" className="statistic_img">
                                <div className="img-wrapper"
                                    style={{transform: 'translate3d(0px, -100%, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)', transformStyle: 'preserve-3d'}}>
                            ...
                            <div id="w-node-db77a3fc-85cd-1cf5-6ef4-8b2e1d14e6cf-1d14e6c8" className="content">
                                ...
                                <div className="w-layout-grid list_grid">
                                    <div className="list_item scroll-slide-left" style={{opacity: 0}}><svg
                                            ...
                                            fill="none" className="icon-1x1-large">
                                            <path
